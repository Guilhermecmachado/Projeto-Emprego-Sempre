...
if ($_SERVER["REQUEST_METHOD"] == 'POST') {
    ...
    if (isset($_POST['btnfil']) && $id != 0) {
        $sql = "SELECT u.id_usuario,u.nome_empresa,c.id_usuario,c.nome_vagas,c.id_area,c.desc_vagas,c.`status`,a.nome_area,c.id_cadastro_vagas,c.email_envio
        FROM cadastro_vagas AS c
        INNER JOIN area_vagas AS a ON a.id_area = c.id_area
        INNER JOIN usuario_empresa as u on u.id_usuario = c.id_usuario WHERE c.id_area = $id";

        $resvaga = mysqli_query($conn, $sql);
    } else {
        $sql = "SELECT u.id_usuario,u.nome_empresa,c.id_usuario,c.nome_vagas,c.id_area,c.desc_vagas,c.`status`,a.nome_area,c.id_cadastro_vagas,c.email_envio
        FROM cadastro_vagas AS c
        INNER JOIN area_vagas AS a ON a.id_area = c.id_area
        INNER JOIN usuario_empresa as u on u.id_usuario = c.id_usuario";
...
<body>
    <nav class="navbar navbar-expand-lg bg-dark ">
        <div class="container-fluid">
            <a class="navbar-brand" href="#"><img src="img/icon.ico" style="height: 60px;"></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link text-white" href="index.php">Vagas</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white" href="usuariocurri.php">Cadastre o seu currículo</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white" href="logincurri.php">Login</a>
                    </li>
                </ul>
                <form method="POST">
                    <div class="d-flex">
                        ...
                        <select class="form-select" name="filtro" id="filtro" aria-label="Default select example">
                            <?php while ($linhaarea = mysqli_fetch_assoc($resTipo)) { ?>
                                <option class="text-dark" value="<?php echo $linhaarea['id_area']; ?>"><?php echo $linhaarea['nome_area']; ?> </option>
                            <?php } ?>
                            <option class="text-dark" value="0">Todos </option>
                        </select>
                    </div>
                </form>
            </div>
    ...
    <div id="layoutSidenav_content">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="our_solution_category">
                            <div class="solution_cards_box">
                                ...
                                <?php while ($linha = mysqli_fetch_assoc($resvaga)) { ?>
                                    <div class="solution_card opacity-75">
                                        ...
                                        <div class="solu_title">
                                            <div class="text">Nome da Empresa: <h4 class="text " value="<?php echo $linha['id_usuario']; ?>"><?php echo $linha['nome_empresa']; ?></h4>
                                            </div>
                                            <div class="text">Nome da Vaga: <h4 class="text " value="<?php echo $linha['id_cadastro_vagas']; ?>"><?php echo $linha['nome_vagas']; ?></h4>
                                            </div>
                                            <div class="text">Area de Atuação: <h6 class="text " value="<?php echo $linha['id_area']; ?>"><?php echo $linha['nome_area']; ?></h6>
                                            </div>

                                        </div>
                                        <div class="solu_description">

                                        <div class="text">Descrição/Requisitos:  <p class="text " value="<?php echo $linha['id_cadastro_vagas']; ?>"><?php echo $linha['desc_vagas']; ?></p></div>
                                            <div class="text">Email: <p class="text " value="<?php echo $linha['id_cadastro_vagas']; ?>"><?php echo $linha['email_envio']; ?></p>
                                            </div>

                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" value="1" name="stat" id="stat" disabled <?php if ($linha['status'] == "1") {
                                                                                                                                            echo "checked";
                                                                                                                                        } ?>>
                                        ...
                                        <div class="col-12 my-1">
                                            <a href=""><button type="button" name="btn-att" id="btn-att" class="btn btn-success">Envie seu curriculo</button></a>
                                        </div>
                                    </div>
                                <?php } ?>
        ...
        <div class="container-fluid bg-dark">
            <footer class="row row-cols-1 row-cols-sm-2 row-cols-md-5 py-5 ">
                ...
                <div class="col mb-3 py-3 text-white">
                    <h5>Ajuda</h5>
                    <ul class="nav flex-column">
                        <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-white">Fale conosco</a></li>
                        <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-white">Precisa de ajuda?</a></li>
