...
if ($_SERVER["REQUEST_METHOD"] == 'POST') {
    if (isset($_POST['btnatt'])) {
        ...
        $sqlempre = "UPDATE usuario_empresa AS u
        INNER JOIN cadastro_vagas as c on u.id_usuario = c.id_usuario
        SET u.nome_empresa = '$nome_empresa', u.email = '$email_empresa' WHERE c.id_cadastro_vagas = '$id';";
        if (mysqli_query($conn, $sqlempre)) {
            echo ' <script> alert("Empresa_atualizada") </script>';
        } else {
            echo ("error");
        }

        $sqlup = "UPDATE cadastro_vagas AS c
        ...
        if (mysqli_query($conn, $sqlup)) {
            echo ' <script> alert("Vaga_atualizada") </script>';
        } else {
            echo ("error");
        }
    }
...
$sql = "SELECT c.nome_vagas,c.id_area,c.id_usuario,c.desc_vagas,c.email_envio,c.status,a.id_area,a.nome_area,u.nome_empresa,u.id_usuario,u.email
            ...
            <div class="container-fluid ">
                <div class="container ">
                    <form method="POST" class="row mt-editar">
                        ...
                        <div class="col-lg-4 ">
                            <label class="form-label text-white">Alterar nome da Empresa</label>
                            <input type="text" name="empresa" id="empresa" value="<?php echo $nome_empresa ?>" required class="my-1 form-control">
                        </div>
                        <div class="col-lg-4 ">
                            <label class="form-label text-white">Alterar email da Empresa</label>
                            <input type="email" name="emailempresa" id="emailempresa" value="<?php echo $email_empresa ?>" required class="my-1 form-control">
                        </div>
                        <div class="col-lg-5 ">
