                            ...
                            <div class=" py-2 my-3 rounded-3">
                                <div class="pb-5 ">
                                    <div class="container mt-5">
                                        ...
                                        <label class="form-label text-white">Email de usuario</label>
    ...
    <div class="container-fluid bg-dark fixed-bottom">
        <footer class="row row-cols-1 row-cols-sm-2 row-cols-md-5 ">
            ...
            <div class="col mb-3 text-white">
                <h5>Redes sociais</h5>
                <ul class="nav flex-column">
                    <li class="nav-item mb-2 heigth"><a href="../https://www.facebook.com/" class="nav-link p-0 text-white"><img src="img/img-original/face-removebg-preview.png" style="height: 25px;"></a></li>
                    <li class="nav-item mb-2 heigth"><a href="../https://twitter.com/" class="nav-link p-0 text-white"><img src="img/img-original/twit.png" style="height: 27px;"></a></li>
                    <li class="nav-item mb-2 heigth"><a href="#" class="nav-link p-0 text-white"><img src="img/img-original/iconewhats.png" style="height: 27px;"></a></li>
