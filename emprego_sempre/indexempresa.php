...
$sql = "SELECT c.id_usuario,c.nome_vagas,c.id_area,c.desc_vagas,c.`status`,a.nome_area,c.id_cadastro_vagas,c.email_envio
FROM cadastro_vagas AS c
INNER JOIN area_vagas AS a ON a.id_area = c.id_area  WHERE c.id_usuario ='$usuario'";
    ...
    <div id="layoutSidenav_content">
        <main class="bg-image">
                                ...
                                <?php while ($linha = mysqli_fetch_assoc($resvaga)) { ?>
                                    <div class="solution_card opacity-75">
                                        ...
                                        <div class="solu_description">
                                            ...
                                            <div class="text">Descrição/Requisitos: <p class="text " value="<?php echo $linha['id_cadastro_vagas']; ?>"><?php echo $linha['desc_vagas']; ?></p>
                                            </div>
                                        ...
                                        <div class="col-12 my-1">
                                            <a href="editar.php?id=<?php echo $linha['id_cadastro_vagas'] ?>"><button type="button" name="btn-att" id="btn-att" class="btn btn-success">Atualizar</button></a>
                                        </div>
                                    </div>
                                <?php } ?>
            ...
            <?php /* while ($linha = mysqli_fetch_assoc($resTipo)) { ?>
                                    <td class="text-white " value="<?php echo $linha['id_cadastro_vagas']; ?>"><?php echo $linha['nome_vagas']; ?></td>
                                    <td class="text-white" value="<?php echo $linha['id_area']; ?>"><?php echo $linha['nome_area']; ?></td>
