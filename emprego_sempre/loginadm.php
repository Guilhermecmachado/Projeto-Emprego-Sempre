...
if ($_SERVER["REQUEST_METHOD"] = "POST") {
    if (isset($_POST["senha"])) {
        ...
        $sql = "SELECT email_adm,
                id_adm, 
                case when senha_adm = MD5('$senha') then 1 ELSE 0 END AS status
                FROM adm
                WHERE email_adm = '$usuario'";
        ...
        if ($retorno == 0) {
            ...
            if ($linha["status"] == 0) {
                ...
                $_SESSION["user_adm"] = $linha["id_adm"];
                $_SESSION["user_email"] = $linha["email_adm"];
                            ...
                            <div class=" py-2 my-3 rounded-3">
                                <div class="pb-5 ">
                                    <div class="container mt-5">
                                        ...
                                        <label class="form-label text-white">Email do Adminstrador</label>
