                                ...
                                <?php while ($linha = mysqli_fetch_assoc($resvaga)) { ?>
                                    <div class="solution_card opacity-75">
                                        ...
                                        <div class="col-12 my-1">
                                            <a href="editadmin.php?id=<?php echo $linha['id_cadastro_vagas'] ?>"><button type="button" name="btn-att" id="btn-att" class="btn btn-success">Atualizar</button></a>
                                        </div>
                                    </div>
                                <?php } ?>
